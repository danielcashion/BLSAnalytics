#
# Name:     bls_data_class.py
# Date:     April 14, 2022
# Author:   Daniel Cashion
#
# Description:
#
# The bls_data class uses Version 2 of the US Bureau of Labor Statistics (BLS) API
...
# To use the bls_data class, create an instance with these inputs:
#
